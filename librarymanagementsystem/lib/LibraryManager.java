...
public class LibraryManager {
    ...
    public synchronized void borrowBook(String memberId, String isbn) {
        ...
        if (member != null && book != null && book.isAvailable()) {
            if (member.getBorrowedBooks().size() < MAX_BOOKS_PER_MEMBER) {
                ...
                System.out.println("lib.Book borrowed: " + book.getTitle() + " by " + member.getName());
            } else {
                System.out.println("lib.Member " + member.getName() + " has reached the maximum number of borrowed books.");
            }
        } else {
            System.out.println("lib.Book or member not found, or book is not available.");
        }
    }
    ...
    public synchronized void returnBook(String memberId, String isbn) {
        ...
        if (member != null && book != null) {
            ...
            System.out.println("lib.Book returned: " + book.getTitle() + " by " + member.getName());
        } else {
            System.out.println("lib.Book or member not found.");
        }
    }
