...
public class LibraryManagementSystemDemo {
    public static void run() {
        ...
        libraryManager.addBook(new Book("ISBN1", "lib.Book 1", "Author 1", 2020));
        libraryManager.addBook(new Book("ISBN2", "lib.Book 2", "Author 2", 2019));
        libraryManager.addBook(new Book("ISBN3", "lib.Book 3", "Author 3", 2021));
        ...
        // Search books
        List<Book> searchResults = libraryManager.searchBooks("lib.Book");
